...
def browse_movies():
    ...
    global movies
    movies=StringVar()
    movies=cinema.browseMovies() #initialize variable with all the available movies
...
def upgrade_account():
    ...
    Button(upgrade_account_screen,text="Confirm Payment",bg="green",foreground="white", font=("Calibri", 13,'bold'),height="2", width="30",activebackground='red').pack() # upgrade_it func here 
